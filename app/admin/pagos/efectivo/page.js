  ...
  return (
    <div style={{ maxWidth: 700, margin: "0 auto", padding: 24 }}>
      ...
      <div style={{ marginBottom: 20, textAlign: "center" }}>
        ...
        <p style={{ color: "#666", margin: 0 }}>Ingresos en efectivo (últimos 30 días)</p>
        {growth !== null && (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Últimos 20 ingresos en efectivo (sistema y manual)</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div style={{ color: "#888", padding: 12 }}>No hay pagos registrados en efectivo.</div>
          ) : (
