...
export default function PagosTarjetaPage() {
  ...
  return (
    <div style={{ maxWidth: 700, margin: "0 auto", padding: 24 }}>
      <Card>
        <CardHeader>
          <CardTitle>Estadísticas de Pagos con Tarjeta</CardTitle>
          <CardDescription>Pagos recibidos con tarjeta, discriminando entre sistema y manual (últimos 30 días)</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
            <div>Cargando...</div>
            ...
            <>
              ...
              <div style={{ marginBottom: 12, fontWeight: 500 }}>Pagos recientes (Tarjeta):</div>
